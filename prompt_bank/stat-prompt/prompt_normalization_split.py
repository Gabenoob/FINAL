    ...
    for split_name, data_path in data_path_buf.items():
        ...
        if mode == "fit":
            ...
            for dataset_dir in dataset_fullname:
                ...
                data_path_buf1.extend(new_dataset)
        ...
        if mode == "fit":
            ...
            mean_std_export_ds(data_path_buf1, normalize_param_fname)
        else:
            # ipdb.set_trace()
            standardscale_export(data_path_buf1, normalize_param_fname, output_path, root_path)
